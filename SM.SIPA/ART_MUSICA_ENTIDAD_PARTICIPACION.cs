...
namespace SM.SIPA
{
    ...
    public partial class ART_MUSICA_ENTIDAD_PARTICIPACION
    {
        public ART_MUSICA_ENTIDAD_PARTICIPACION()
        {
            this.ART_MUSICA_TIPO_PROY_ORG_COM = new HashSet<ART_MUSICA_TIPO_PROY_ORG_COM>();
        }
        ...
        public int ENT_CANTIDAD_ALUMNOS_DESVINCULADOS { get; set; }
        public int ENT_CANTIDAD_ALUMNOS_VULNERABLES { get; set; }
        ...
        public Nullable<int> ENT_CANTIDAD_ALUMNOS_REDUNIDOS { get; set; }
        public Nullable<int> ENT_CANTIDAD_ALUMNOS_CUPOS { get; set; }
    
        public virtual ART_ENTIDADES_ARTES ART_ENTIDADES_ARTES { get; set; }
        public virtual ART_MUSICA_ORGANIZACION_COMUNITARIA ART_MUSICA_ORGANIZACION_COMUNITARIA { get; set; }
        public virtual ICollection<ART_MUSICA_TIPO_PROY_ORG_COM> ART_MUSICA_TIPO_PROY_ORG_COM { get; set; }
    }
}
