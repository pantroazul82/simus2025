...
(function($ , undefined) {
	$.fn.ace_wysiwyg = function($options , undefined) {
		...
		var button_defaults =
		{
			...
			'justifyleft' : {
				icon : 'fa fa-bars fa-2x-left',
				title : 'Align Left (Ctrl/Cmd+L)'
			},
			'justifycenter' : {
				icon : 'fa fa-bars fa-2x-center',
				title : 'Center (Ctrl/Cmd+E)'
			},
			'justifyright' : {
				icon : 'fa fa-bars fa-2x-right',
				title : 'Align Right (Ctrl/Cmd+R)'
			},
			'justifyfull' : {
				icon : 'fa fa-bars fa-2x-justify',
			...
			'insertImage' : {
				...
				button_text : '<i class="'+ ace.vars['icon'] + 'fa-file-pdf fa-2x"></i> Choose Image &hellip;',
