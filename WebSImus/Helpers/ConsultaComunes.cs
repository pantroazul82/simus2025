...
{
    public class ConsultaComunes
    {
        public static List<BasicaDTO> ObtenerActor(string tipo, string UsuaroId, string correo)
        {
            ...
            if (!String.IsNullOrEmpty(tipo))
            {
                ...
                {
                    decimal UsuarioSipaId = SM.Aplicacion.Modulo_Usuarios.UsuarioLogica.ObtenerUsuarioSipaId(correo);
