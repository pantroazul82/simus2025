...
namespace Oauth2Login.Service
{
    ...
    public class FacebookUserData : BaseUserData
    {
        ...
        public override string photo { get { return picture; } }
        public override string genero { get { return gender; } }
        public override string nombre { get { return first_name == null ? name : first_name; } }
        public override string apellido { get { return last_name; } }
